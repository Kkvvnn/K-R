/*
 *      Упражнение 1.13.
 *  Напишите программу для вывода гистограммы длин
 *  слов во входном потоке. Построить гистограмму с горизонтальными
 *  рядами довольно легко, а вот с вертикальными столбцами труднее.
 *
 *	Vladimir Kashin
